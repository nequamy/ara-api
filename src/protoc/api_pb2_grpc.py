...
import protoc.api_pb2 as api__pb2
...
class DriverManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetSensorDataRPC = channel.unary_stream(
                '/DriverManager/GetSensorDataRPC',
                request_serializer=api__pb2.GetRequest.SerializeToString,
                response_deserializer=api__pb2.SensorData.FromString,
...
def add_DriverManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSensorDataRPC': grpc.unary_stream_rpc_method_handler(
                    servicer.GetSensorDataRPC,
                    request_deserializer=api__pb2.GetRequest.FromString,
                    response_serializer=api__pb2.SensorData.SerializeToString,
            ),
    }
...
class DriverManager(object):
    ...
    def GetSensorDataRPC(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            api__pb2.SensorData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
